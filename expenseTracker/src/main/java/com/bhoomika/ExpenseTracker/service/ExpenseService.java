...
public class ExpenseService {
    ...
    public ExpenseResponse createExpense(ExpenseRequest request) {
        ...
        // balanceService.updateBalancesAfterExpense(savedExpense,participants);
        // balanceService.simplifyDebts(savedExpense.getGroup().getGroupId());

        // Update balances and log transactions atomically
        balanceService.updateBalancesAndLogTransactionAfterExpense(savedExpense, participants);
